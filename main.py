...
def get_url(category,start):
    ...
    ("title_type", title_type_dict[__settings__.getSetting( "title_type" )]),
    ...
    ("countries", countries_dict[__settings__.getSetting( "countries" )]),
    ("languages", languages_dict[__settings__.getSetting( "languages" )]),
